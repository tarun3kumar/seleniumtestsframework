...
public class MarionetteDriverFactory extends AbstractWebDriverFactory implements IWebDriverFactory {
    private long timeout = 60;

    /**
     * @param  cfg  the configuration of the marionetteDriver
     */
    public MarionetteDriverFactory(final DriverConfig cfg) {
        super(cfg);
    }
    ...
    public WebDriver createWebDriver() {
        ...
        System.out.println("start create marionette");
        driver = createWebDriverWithTimeout();

        System.out.println("end create marionette");
